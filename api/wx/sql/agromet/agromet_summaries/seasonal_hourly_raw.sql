...
SELECT
    ...
    ,ad.year
    ,"JFM"
    ,ROUND(((100*"JFM_count")::numeric/"JFM_total"::numeric),1) AS "JFM (% of days)"
    ,"FMA"
    ,ROUND(((100*"FMA_count")::numeric/"FMA_total"::numeric),1) AS "FMA (% of days)"
    ,"MAM"
    ,ROUND(((100*"MAM_count")::numeric/"MAM_total"::numeric),1) AS "MAM (% of days)"
    ,"AMJ"
    ,ROUND(((100*"AMJ_count")::numeric/"AMJ_total"::numeric),1) AS "AMJ (% of days)"
    ,"MJJ"
    ,ROUND(((100*"MJJ_count")::numeric/"MJJ_total"::numeric),1) AS "MJJ (% of days)"
    ,"JJA"
    ,ROUND(((100*"JJA_count")::numeric/"JJA_total"::numeric),1) AS "JJA (% of days)"
    ,"JAS"
    ,ROUND(((100*"JAS_count")::numeric/"JAS_total"::numeric),1) AS "JAS (% of days)"
    ,"ASO"
    ,ROUND(((100*"ASO_count")::numeric/"ASO_total"::numeric),1) AS "ASO (% of days)"
    ,"SON"
    ,ROUND(((100*"SON_count")::numeric/"SON_total"::numeric),1) AS "SON (% of days)"
    ,"OND"
    ,ROUND(((100*"OND_count")::numeric/"OND_total"::numeric),1) AS "OND (% of days)"
    ,"NDJ"
    ,ROUND(((100*"NDJ_count")::numeric/"NDJ_total"::numeric),1) AS "NDJ (% of days)"
    ,"DRY"
    ,ROUND(((100*"DRY_count")::numeric/"DRY_total"::numeric),1) AS "DRY (% of days)"
    ,"WET"
    ,ROUND(((100*"WET_count")::numeric/"WET_total"::numeric),1) AS "WET (% of days)"
    ,"ANNUAL"
    ,ROUND(((100*"ANNUAL_count")::numeric/"ANNUAL_total"::numeric),1) AS "ANNUAL (% of days)"
    ,"DJFM"
    ,ROUND(((100*"DJFM_count")::numeric/"DJFM_total"::numeric),1) AS "DJFM (% of days)"
