...
,daily_data AS (
    SELECT
        station_id
        ,vr.symbol || ' FIRST DATE' AS product
        ,day
...
,aggreated_data AS (
    SELECT
        ...
        ,product
        ,year
        ,MIN(day) FILTER (WHERE (is_jfm AND min_value > {{threshold}})) AS "JFM_first_date"
        ...
        ,MIN(day) FILTER (WHERE (is_fma AND min_value > {{threshold}})) AS "FMA_first_date"
        ...
        ,MIN(day) FILTER (WHERE (is_mam AND min_value > {{threshold}})) AS "MAM_first_date"
        ...
        ,MIN(day) FILTER (WHERE (is_amj AND min_value > {{threshold}})) AS "AMJ_first_date"
        ...
        ,MIN(day) FILTER (WHERE (is_mjj AND min_value > {{threshold}})) AS "MJJ_first_date"
        ...
        ,MIN(day) FILTER (WHERE (is_jja AND min_value > {{threshold}})) AS "JJA_first_date"
        ...
        ,MIN(day) FILTER (WHERE (is_jas AND min_value > {{threshold}})) AS "JAS_first_date"
        ...
        ,MIN(day) FILTER (WHERE (is_aso AND min_value > {{threshold}})) AS "ASO_first_date"
        ...
        ,MIN(day) FILTER (WHERE (is_son AND min_value > {{threshold}})) AS "SON_first_date"
        ...
        ,MIN(day) FILTER (WHERE (is_ond AND min_value > {{threshold}})) AS "OND_first_date"
        ...
        ,MIN(day) FILTER (WHERE (is_ndj AND min_value > {{threshold}})) AS "NDJ_first_date"
        ...
        ,MIN(day) FILTER (WHERE (is_dry AND min_value > {{threshold}})) AS "DRY_first_date"
        ...
        ,MIN(day) FILTER (WHERE (is_wet AND min_value > {{threshold}})) AS "WET_first_date"
        ...
        ,MIN(day) FILTER (WHERE (is_annual AND min_value > {{threshold}})) AS "ANNUAL_first_date"
        ...
        ,MIN(day) FILTER (WHERE (is_djfm AND min_value > {{threshold}})) AS "DJFM_first_date"
...
SELECT
    ...
    ,product
    ,year
    ,CASE WHEN "JFM (% of days)" >= (100-{{max_day_pct}}) THEN "JFM_first_date" ELSE NULL END AS "JFM_1"
    ,"JFM (% of days)" 
    ,CASE WHEN "FMA (% of days)" >= (100-{{max_day_pct}}) THEN "FMA_first_date" ELSE NULL END AS "FMA_1"
    ,"FMA (% of days)"
    ,CASE WHEN "MAM (% of days)" >= (100-{{max_day_pct}}) THEN "MAM_first_date" ELSE NULL END AS "MAM_1"
    ,"MAM (% of days)"
    ,CASE WHEN "AMJ (% of days)" >= (100-{{max_day_pct}}) THEN "AMJ_first_date" ELSE NULL END AS "AMJ_1"
    ,"AMJ (% of days)"
    ,CASE WHEN "MJJ (% of days)" >= (100-{{max_day_pct}}) THEN "MJJ_first_date" ELSE NULL END AS "MJJ_1"
    ,"MJJ (% of days)"
    ,CASE WHEN "JJA (% of days)" >= (100-{{max_day_pct}}) THEN "JJA_first_date" ELSE NULL END AS "JJA_1"
    ,"JJA (% of days)"
    ,CASE WHEN "JAS (% of days)" >= (100-{{max_day_pct}}) THEN "JAS_first_date" ELSE NULL END AS "JAS_1"
    ,"JAS (% of days)"
    ,CASE WHEN "ASO (% of days)" >= (100-{{max_day_pct}}) THEN "ASO_first_date" ELSE NULL END AS "ASO_1"
    ,"ASO (% of days)"
    ,CASE WHEN "SON (% of days)" >= (100-{{max_day_pct}}) THEN "SON_first_date" ELSE NULL END AS "SON_1"
    ,"SON (% of days)"
    ,CASE WHEN "OND (% of days)" >= (100-{{max_day_pct}}) THEN "OND_first_date" ELSE NULL END AS "OND_1"
    ,"OND (% of days)"
    ,CASE WHEN "NDJ (% of days)" >= (100-{{max_day_pct}}) THEN "NDJ_first_date" ELSE NULL END AS "NDJ_1"
    ,"NDJ (% of days)"
    ,CASE WHEN "DRY (% of days)" >= (100-{{max_day_pct}}) THEN "DRY_first_date" ELSE NULL END AS "DRY_1"
    ,"DRY (% of days)"
    ,CASE WHEN "WET (% of days)" >= (100-{{max_day_pct}}) THEN "WET_first_date" ELSE NULL END AS "WET_1"
    ,"WET (% of days)"
    ,CASE WHEN "ANNUAL (% of days)" >= (100-{{max_day_pct}}) THEN "ANNUAL_first_date" ELSE NULL END AS "ANNUAL_1"
    ,"ANNUAL (% of days)"
    ,CASE WHEN "DJFM (% of days)" >= (100-{{max_day_pct}}) THEN "DJFM_first_date" ELSE NULL END AS "DJFM_1"
    ,"DJFM (% of days)"
