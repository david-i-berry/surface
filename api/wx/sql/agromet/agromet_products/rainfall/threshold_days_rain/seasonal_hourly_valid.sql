...
,aggreated_data AS (
    SELECT
        st.name AS station
        ,year
        ,COUNT(*) FILTER(WHERE (is_jfm) AND (precip > {{threshold}})) AS "JFM_above"
        ...
        ,COUNT(*) FILTER(WHERE (is_fma) AND (precip > {{threshold}})) AS "FMA_above"
        ...
        ,COUNT(*) FILTER(WHERE (is_mam) AND (precip > {{threshold}})) AS "MAM_above"
        ...
        ,COUNT(*) FILTER(WHERE (is_amj) AND (precip > {{threshold}})) AS "AMJ_above"
        ...
        ,COUNT(*) FILTER(WHERE (is_mjj) AND (precip > {{threshold}})) AS "MJJ_above"
        ...
        ,COUNT(*) FILTER(WHERE (is_jja) AND (precip > {{threshold}})) AS "JJA_above"
        ...
        ,COUNT(*) FILTER(WHERE (is_jas) AND (precip > {{threshold}})) AS "JAS_above"
        ...
        ,COUNT(*) FILTER(WHERE (is_aso) AND (precip > {{threshold}})) AS "ASO_above"
        ...
        ,COUNT(*) FILTER(WHERE (is_son) AND (precip > {{threshold}})) AS "SON_above"
        ...
        ,COUNT(*) FILTER(WHERE (is_ond) AND (precip > {{threshold}})) AS "OND_above"
        ...
        ,COUNT(*) FILTER(WHERE (is_ndj) AND (precip > {{threshold}})) AS "NDJ_above"
        ...
        ,COUNT(*) FILTER(WHERE (is_dry) AND (precip > {{threshold}})) AS "DRY_above"
        ...
        ,COUNT(*) FILTER(WHERE (is_wet) AND (precip > {{threshold}})) AS "WET_above"
        ...
        ,COUNT(*) FILTER(WHERE (is_annual) AND (precip > {{threshold}})) AS "ANNUAL_above"
        ...
        ,COUNT(*) FILTER(WHERE (is_djfm) AND (precip > {{threshold}})) AS "DJFM_above"
...
SELECT
    station
    ,'Number of days with specified rainfall' AS product
    ,ad.year
    ,CASE 
        ...
        ELSE ROUND("JFM_above"::numeric,2)::text
    END AS "JFM"
    ...
    ,CASE 
        ...
        ELSE ROUND("FMA_above"::numeric,2)::text
    END AS "FMA"
    ...
    ,CASE 
        ...
        ELSE ROUND("MAM_above"::numeric,2)::text
    END AS "MAM"
    ...
    ,CASE 
        ...
        ELSE ROUND("AMJ_above"::numeric,2)::text
    END AS "AMJ"
    ...
    ,CASE 
        ...
        ELSE ROUND("MJJ_above"::numeric,2)::text
    END AS "MJJ"
    ...
    ,CASE 
        ...
        ELSE ROUND("JJA_above"::numeric,2)::text
    END AS "JJA"
    ...
    ,CASE 
        ...
        ELSE ROUND("JAS_above"::numeric,2)::text
    END AS "JAS"
    ...
    ,CASE 
        ...
        ELSE ROUND("ASO_above"::numeric,2)::text
    END AS "ASO"
    ...
    ,CASE 
        ...
        ELSE ROUND("SON_above"::numeric,2)::text
    END AS "SON"
    ...
    ,CASE 
        ...
        ELSE ROUND("OND_above"::numeric,2)::text
    END AS "OND"
    ...
    ,CASE 
        ...
        ELSE ROUND("NDJ_above"::numeric,2)::text
    END AS "NDJ"
    ...
    ,CASE 
        ...
        ELSE ROUND("DRY_above"::numeric,2)::text
    END AS "DRY"
    ...
    ,CASE 
        ...
        ELSE ROUND("WET_above"::numeric,2)::text
    END AS "WET"
    ...
    ,CASE 
        ...
        ELSE ROUND("ANNUAL_above"::numeric,2)::text
    END AS "ANNUAL"
    ...
    ,CASE 
        ...
        ELSE ROUND("DJFM_above"::numeric,2)::text
    END AS "DJFM"
