...
,spi_window_calc AS (   
    SELECT
        ...
        ,window_size
        ,CASE window_size
            WHEN 1 THEN MAX(CASE WHEN first_month_w = month THEN fm_day_gap ELSE day_gap END) OVER w1
            WHEN 3 THEN MAX(CASE WHEN first_month_w = month THEN fm_day_gap ELSE day_gap END) OVER w3
            WHEN 6 THEN MAX(CASE WHEN first_month_w = month THEN fm_day_gap ELSE day_gap END) OVER w6
            WHEN 12 THEN MAX(CASE WHEN first_month_w = month THEN fm_day_gap ELSE day_gap END) OVER w12
            WHEN 24 THEN MAX(CASE WHEN first_month_w = month THEN fm_day_gap ELSE day_gap END) OVER w24
        END AS day_gap_w
        ,CASE window_size
