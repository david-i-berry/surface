...
,aggreated_data AS (
    SELECT
        st.name AS station
        ,year
        ,COUNT(*) FILTER(WHERE is_jfm AND precip > 25) AS "JFM_25"
        ,COUNT(*) FILTER(WHERE is_jfm AND precip > 50) AS "JFM_50"
        ,COUNT(*) FILTER(WHERE is_jfm AND precip > 84) AS "JFM_84"
        ,COUNT(*) FILTER(WHERE is_jfm AND precip > 200) AS "JFM_200"
        ...
        ,COUNT(*) FILTER(WHERE is_fma AND precip > 25) AS "FMA_25"
        ,COUNT(*) FILTER(WHERE is_fma AND precip > 50) AS "FMA_50"
        ,COUNT(*) FILTER(WHERE is_fma AND precip > 84) AS "FMA_84"
        ,COUNT(*) FILTER(WHERE is_fma AND precip > 200) AS "FMA_200"
        ...
        ,COUNT(*) FILTER(WHERE is_mam AND precip > 25) AS "MAM_25"
        ,COUNT(*) FILTER(WHERE is_mam AND precip > 50) AS "MAM_50"
        ,COUNT(*) FILTER(WHERE is_mam AND precip > 84) AS "MAM_84"
        ,COUNT(*) FILTER(WHERE is_mam AND precip > 200) AS "MAM_200"
        ...
        ,COUNT(*) FILTER(WHERE is_amj AND precip > 25) AS "AMJ_25"
        ,COUNT(*) FILTER(WHERE is_amj AND precip > 50) AS "AMJ_50"
        ,COUNT(*) FILTER(WHERE is_amj AND precip > 84) AS "AMJ_84"
        ,COUNT(*) FILTER(WHERE is_amj AND precip > 200) AS "AMJ_200"
        ...
        ,COUNT(*) FILTER(WHERE is_mjj AND precip > 25) AS "MJJ_25"
        ,COUNT(*) FILTER(WHERE is_mjj AND precip > 50) AS "MJJ_50"
        ,COUNT(*) FILTER(WHERE is_mjj AND precip > 84) AS "MJJ_84"
        ,COUNT(*) FILTER(WHERE is_mjj AND precip > 200) AS "MJJ_200"
        ...
        ,COUNT(*) FILTER(WHERE is_jja AND precip > 25) AS "JJA_25"
        ,COUNT(*) FILTER(WHERE is_jja AND precip > 50) AS "JJA_50"
        ,COUNT(*) FILTER(WHERE is_jja AND precip > 84) AS "JJA_84"
        ,COUNT(*) FILTER(WHERE is_jja AND precip > 200) AS "JJA_200"
        ...
        ,COUNT(*) FILTER(WHERE is_jas AND precip > 25) AS "JAS_25"
        ,COUNT(*) FILTER(WHERE is_jas AND precip > 50) AS "JAS_50"
        ,COUNT(*) FILTER(WHERE is_jas AND precip > 84) AS "JAS_84"
        ,COUNT(*) FILTER(WHERE is_jas AND precip > 200) AS "JAS_200"
        ...
        ,COUNT(*) FILTER(WHERE is_aso AND precip > 25) AS "ASO_25"
        ,COUNT(*) FILTER(WHERE is_aso AND precip > 50) AS "ASO_50"
        ,COUNT(*) FILTER(WHERE is_aso AND precip > 84) AS "ASO_84"
        ,COUNT(*) FILTER(WHERE is_aso AND precip > 200) AS "ASO_200"
        ...
        ,COUNT(*) FILTER(WHERE is_son AND precip > 25) AS "SON_25"
        ,COUNT(*) FILTER(WHERE is_son AND precip > 50) AS "SON_50"
        ,COUNT(*) FILTER(WHERE is_son AND precip > 84) AS "SON_84"
        ,COUNT(*) FILTER(WHERE is_son AND precip > 200) AS "SON_200"
        ...
        ,COUNT(*) FILTER(WHERE is_ond AND precip > 25) AS "OND_25"
        ,COUNT(*) FILTER(WHERE is_ond AND precip > 50) AS "OND_50"
        ,COUNT(*) FILTER(WHERE is_ond AND precip > 84) AS "OND_84"
        ,COUNT(*) FILTER(WHERE is_ond AND precip > 200) AS "OND_200"
        ...
        ,COUNT(*) FILTER(WHERE is_ndj AND precip > 25) AS "NDJ_25"
        ,COUNT(*) FILTER(WHERE is_ndj AND precip > 50) AS "NDJ_50"
        ,COUNT(*) FILTER(WHERE is_ndj AND precip > 84) AS "NDJ_84"
        ,COUNT(*) FILTER(WHERE is_ndj AND precip > 200) AS "NDJ_200"
        ...
        ,COUNT(*) FILTER(WHERE is_dry AND precip > 25) AS "DRY_25"
        ,COUNT(*) FILTER(WHERE is_dry AND precip > 50) AS "DRY_50"
        ,COUNT(*) FILTER(WHERE is_dry AND precip > 84) AS "DRY_84"
        ,COUNT(*) FILTER(WHERE is_dry AND precip > 200) AS "DRY_200"
        ...
        ,COUNT(*) FILTER(WHERE is_wet AND precip > 25) AS "WET_25"
        ,COUNT(*) FILTER(WHERE is_wet AND precip > 50) AS "WET_50"
        ,COUNT(*) FILTER(WHERE is_wet AND precip > 84) AS "WET_84"
        ,COUNT(*) FILTER(WHERE is_wet AND precip > 200) AS "WET_200"
        ...
        ,COUNT(*) FILTER(WHERE is_annual AND precip > 25) AS "ANNUAL_25"
        ,COUNT(*) FILTER(WHERE is_annual AND precip > 50) AS "ANNUAL_50"
        ,COUNT(*) FILTER(WHERE is_annual AND precip > 84) AS "ANNUAL_84"
        ,COUNT(*) FILTER(WHERE is_annual AND precip > 200) AS "ANNUAL_200"
        ...
        ,COUNT(*) FILTER(WHERE is_djfm AND precip > 25) AS "DJFM_25"
        ,COUNT(*) FILTER(WHERE is_djfm AND precip > 50) AS "DJFM_50"
        ,COUNT(*) FILTER(WHERE is_djfm AND precip > 84) AS "DJFM_84"
        ,COUNT(*) FILTER(WHERE is_djfm AND precip > 200) AS "DJFM_200"
...
SELECT
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN '25 mm Rainfall' THEN ROUND("JFM_25"::numeric,2)::text
                WHEN '50 mm Rainfall' THEN ROUND("JFM_50"::numeric,2)::text
                WHEN '84 mm Rainfall' THEN ROUND("JFM_84"::numeric,2)::text
                WHEN '200 mm Rainfall' THEN ROUND("JFM_200"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "JFM"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN '25 mm Rainfall' THEN ROUND("FMA_25"::numeric,2)::text
                WHEN '50 mm Rainfall' THEN ROUND("FMA_50"::numeric,2)::text
                WHEN '84 mm Rainfall' THEN ROUND("FMA_84"::numeric,2)::text
                WHEN '200 mm Rainfall' THEN ROUND("FMA_200"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "FMA"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN '25 mm Rainfall' THEN ROUND("MAM_25"::numeric,2)::text
                WHEN '50 mm Rainfall' THEN ROUND("MAM_50"::numeric,2)::text
                WHEN '84 mm Rainfall' THEN ROUND("MAM_84"::numeric,2)::text
                WHEN '200 mm Rainfall' THEN ROUND("MAM_200"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "MAM"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN '25 mm Rainfall' THEN ROUND("AMJ_25"::numeric,2)::text
                WHEN '50 mm Rainfall' THEN ROUND("AMJ_50"::numeric,2)::text
                WHEN '84 mm Rainfall' THEN ROUND("AMJ_84"::numeric,2)::text
                WHEN '200 mm Rainfall' THEN ROUND("AMJ_200"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "AMJ"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN '25 mm Rainfall' THEN ROUND("MJJ_25"::numeric,2)::text
                WHEN '50 mm Rainfall' THEN ROUND("MJJ_50"::numeric,2)::text
                WHEN '84 mm Rainfall' THEN ROUND("MJJ_84"::numeric,2)::text
                WHEN '200 mm Rainfall' THEN ROUND("MJJ_200"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "MJJ"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN '25 mm Rainfall' THEN ROUND("JJA_25"::numeric,2)::text
                WHEN '50 mm Rainfall' THEN ROUND("JJA_50"::numeric,2)::text
                WHEN '84 mm Rainfall' THEN ROUND("JJA_84"::numeric,2)::text
                WHEN '200 mm Rainfall' THEN ROUND("JJA_200"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "JJA"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN '25 mm Rainfall' THEN ROUND("JAS_25"::numeric,2)::text
                WHEN '50 mm Rainfall' THEN ROUND("JAS_50"::numeric,2)::text
                WHEN '84 mm Rainfall' THEN ROUND("JAS_84"::numeric,2)::text
                WHEN '200 mm Rainfall' THEN ROUND("JAS_200"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "JAS"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN '25 mm Rainfall' THEN ROUND("ASO_25"::numeric,2)::text
                WHEN '50 mm Rainfall' THEN ROUND("ASO_50"::numeric,2)::text
                WHEN '84 mm Rainfall' THEN ROUND("ASO_84"::numeric,2)::text
                WHEN '200 mm Rainfall' THEN ROUND("ASO_200"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "ASO"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN '25 mm Rainfall' THEN ROUND("SON_25"::numeric,2)::text
                WHEN '50 mm Rainfall' THEN ROUND("SON_50"::numeric,2)::text
                WHEN '84 mm Rainfall' THEN ROUND("SON_84"::numeric,2)::text
                WHEN '200 mm Rainfall' THEN ROUND("SON_200"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "SON"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN '25 mm Rainfall' THEN ROUND("OND_25"::numeric,2)::text
                WHEN '50 mm Rainfall' THEN ROUND("OND_50"::numeric,2)::text
                WHEN '84 mm Rainfall' THEN ROUND("OND_84"::numeric,2)::text
                WHEN '200 mm Rainfall' THEN ROUND("OND_200"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "OND"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN '25 mm Rainfall' THEN ROUND("NDJ_25"::numeric,2)::text
                WHEN '50 mm Rainfall' THEN ROUND("NDJ_50"::numeric,2)::text
                WHEN '84 mm Rainfall' THEN ROUND("NDJ_84"::numeric,2)::text
                WHEN '200 mm Rainfall' THEN ROUND("NDJ_200"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "NDJ"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN '25 mm Rainfall' THEN ROUND("DRY_25"::numeric,2)::text
                WHEN '50 mm Rainfall' THEN ROUND("DRY_50"::numeric,2)::text
                WHEN '84 mm Rainfall' THEN ROUND("DRY_84"::numeric,2)::text
                WHEN '200 mm Rainfall' THEN ROUND("DRY_200"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "DRY"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN '25 mm Rainfall' THEN ROUND("WET_25"::numeric,2)::text
                WHEN '50 mm Rainfall' THEN ROUND("WET_50"::numeric,2)::text
                WHEN '84 mm Rainfall' THEN ROUND("WET_84"::numeric,2)::text
                WHEN '200 mm Rainfall' THEN ROUND("WET_200"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "WET"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN '25 mm Rainfall' THEN ROUND("ANNUAL_25"::numeric,2)::text
                WHEN '50 mm Rainfall' THEN ROUND("ANNUAL_50"::numeric,2)::text
                WHEN '84 mm Rainfall' THEN ROUND("ANNUAL_84"::numeric,2)::text
                WHEN '200 mm Rainfall' THEN ROUND("ANNUAL_200"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "ANNUAL"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN '25 mm Rainfall' THEN ROUND("DJFM_25"::numeric,2)::text
                WHEN '50 mm Rainfall' THEN ROUND("DJFM_50"::numeric,2)::text
                WHEN '84 mm Rainfall' THEN ROUND("DJFM_84"::numeric,2)::text
                WHEN '200 mm Rainfall' THEN ROUND("DJFM_200"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "DJFM"
