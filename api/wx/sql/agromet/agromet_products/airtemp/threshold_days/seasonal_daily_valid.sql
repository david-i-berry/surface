...
,aggregation_pct AS (
    SELECT
        ...
        ,CASE WHEN "DJFM_max_day_gap" <= {{max_day_gap}} THEN "DJFM_below"||'/'||"DJFM_equal"||'/'||"DJFM_above" ELSE NULL END AS "DJFM"
