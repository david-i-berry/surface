...
,aggreated_data AS (
    SELECT
        st.name AS station
        ,year
        ,COUNT(*) FILTER(WHERE ((is_jfm) AND {{threshold}} < min_value)) AS "JFM_below"
        ,COUNT(*) FILTER(WHERE ((is_jfm) AND {{threshold}} > max_value)) AS "JFM_above"
        ...
        ,COUNT(*) FILTER(WHERE ((is_fma) AND {{threshold}} < min_value)) AS "FMA_below"
        ,COUNT(*) FILTER(WHERE ((is_fma) AND {{threshold}} > max_value)) AS "FMA_above"
        ...
        ,COUNT(*) FILTER(WHERE ((is_mam) AND {{threshold}} < min_value)) AS "MAM_below"
        ,COUNT(*) FILTER(WHERE ((is_mam) AND {{threshold}} > max_value)) AS "MAM_above"
        ...
        ,COUNT(*) FILTER(WHERE ((is_amj) AND {{threshold}} < min_value)) AS "AMJ_below"
        ,COUNT(*) FILTER(WHERE ((is_amj) AND {{threshold}} > max_value)) AS "AMJ_above"
        ...
        ,COUNT(*) FILTER(WHERE ((is_mjj) AND {{threshold}} < min_value)) AS "MJJ_below"
        ,COUNT(*) FILTER(WHERE ((is_mjj) AND {{threshold}} > max_value)) AS "MJJ_above"
        ...
        ,COUNT(*) FILTER(WHERE ((is_jja) AND {{threshold}} < min_value)) AS "JJA_below"
        ,COUNT(*) FILTER(WHERE ((is_jja) AND {{threshold}} > max_value)) AS "JJA_above"
        ...
        ,COUNT(*) FILTER(WHERE ((is_jas) AND {{threshold}} < min_value)) AS "JAS_below"
        ,COUNT(*) FILTER(WHERE ((is_jas) AND {{threshold}} > max_value)) AS "JAS_above"
        ...
        ,COUNT(*) FILTER(WHERE ((is_aso) AND {{threshold}} < min_value)) AS "ASO_below"
        ,COUNT(*) FILTER(WHERE ((is_aso) AND {{threshold}} > max_value)) AS "ASO_above"
        ...
        ,COUNT(*) FILTER(WHERE ((is_son) AND {{threshold}} < min_value)) AS "SON_below"
        ,COUNT(*) FILTER(WHERE ((is_son) AND {{threshold}} > max_value)) AS "SON_above"
        ...
        ,COUNT(*) FILTER(WHERE ((is_ond) AND {{threshold}} < min_value)) AS "OND_below"
        ,COUNT(*) FILTER(WHERE ((is_ond) AND {{threshold}} > max_value)) AS "OND_above"
        ...
        ,COUNT(*) FILTER(WHERE ((is_ndj) AND {{threshold}} < min_value)) AS "NDJ_below"
        ,COUNT(*) FILTER(WHERE ((is_ndj) AND {{threshold}} > max_value)) AS "NDJ_above"
        ...
        ,COUNT(*) FILTER(WHERE ((is_dry) AND {{threshold}} < min_value)) AS "DRY_below"
        ,COUNT(*) FILTER(WHERE ((is_dry) AND {{threshold}} > max_value)) AS "DRY_above"
        ...
        ,COUNT(*) FILTER(WHERE ((is_wet) AND {{threshold}} < min_value)) AS "WET_below"
        ,COUNT(*) FILTER(WHERE ((is_wet) AND {{threshold}} > max_value)) AS "WET_above"
        ...
        ,COUNT(*) FILTER(WHERE ((is_annual) AND {{threshold}} < min_value)) AS "ANNUAL_below"
        ,COUNT(*) FILTER(WHERE ((is_annual) AND {{threshold}} > max_value)) AS "ANNUAL_above"
        ...
        ,COUNT(*) FILTER(WHERE ((is_djfm) AND {{threshold}} < min_value)) AS "DJFM_below"
        ,COUNT(*) FILTER(WHERE ((is_djfm) AND {{threshold}} > max_value)) AS "DJFM_above"
