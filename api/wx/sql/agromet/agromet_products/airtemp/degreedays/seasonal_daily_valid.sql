...
,aggreated_data AS (
    SELECT
        st.name AS station
        ,year
        ,ROUND(SUM(CASE WHEN is_jfm THEN value END)::numeric, 2) AS "JFM"
        ...
        ,ROUND(SUM(CASE WHEN is_fma THEN value END)::numeric, 2) AS "FMA"
        ...
        ,ROUND(SUM(CASE WHEN is_mam THEN value END)::numeric, 2) AS "MAM"
        ...
        ,ROUND(SUM(CASE WHEN is_amj THEN value END)::numeric, 2) AS "AMJ"
        ...
        ,ROUND(SUM(CASE WHEN is_mjj THEN value END)::numeric, 2) AS "MJJ"
        ...
        ,ROUND(SUM(CASE WHEN is_jja THEN value END)::numeric, 2) AS "JJA"
        ...
        ,ROUND(SUM(CASE WHEN is_jas THEN value END)::numeric, 2) AS "JAS"
        ...
        ,ROUND(SUM(CASE WHEN is_aso THEN value END)::numeric, 2) AS "ASO"
        ...
        ,ROUND(SUM(CASE WHEN is_son THEN value END)::numeric, 2) AS "SON"
        ...
        ,ROUND(SUM(CASE WHEN is_ond THEN value END)::numeric, 2) AS "OND"
        ...
        ,ROUND(SUM(CASE WHEN is_ndj THEN value END)::numeric, 2) AS "NDJ"
        ...
        ,ROUND(SUM(CASE WHEN is_dry THEN value END)::numeric, 2) AS "DRY"
        ...
        ,ROUND(SUM(CASE WHEN is_wet THEN value END)::numeric, 2) AS "WET"
        ...
        ,ROUND(SUM(CASE WHEN is_annual THEN value END)::numeric, 2) AS "ANNUAL"
        ...
        ,ROUND(SUM(CASE WHEN is_djfm THEN value END)::numeric, 2) AS "DJFM"
