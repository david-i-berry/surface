...
,aggreated_data AS (
    SELECT
        st.name AS station
        ,year
        ,ROUND(SUM(CASE WHEN is_jfm THEN solar_rad END)::numeric, 2) AS "JFM_sum"
        ...
        ,ROUND(SUM(CASE WHEN is_fma THEN solar_rad END)::numeric, 2) AS "FMA_sum"
        ...
        ,ROUND(SUM(CASE WHEN is_mam THEN solar_rad END)::numeric, 2) AS "MAM_sum"
        ...
        ,ROUND(SUM(CASE WHEN is_amj THEN solar_rad END)::numeric, 2) AS "AMJ_sum"
        ...
        ,ROUND(SUM(CASE WHEN is_mjj THEN solar_rad END)::numeric, 2) AS "MJJ_sum"
        ...
        ,ROUND(SUM(CASE WHEN is_jja THEN solar_rad END)::numeric, 2) AS "JJA_sum"
        ...
        ,ROUND(SUM(CASE WHEN is_jas THEN solar_rad END)::numeric, 2) AS "JAS_sum"
        ...
        ,ROUND(SUM(CASE WHEN is_aso THEN solar_rad END)::numeric, 2) AS "ASO_sum"
        ...
        ,ROUND(SUM(CASE WHEN is_son THEN solar_rad END)::numeric, 2) AS "SON_sum"
        ...
        ,ROUND(SUM(CASE WHEN is_ond THEN solar_rad END)::numeric, 2) AS "OND_sum"
        ...
        ,ROUND(SUM(CASE WHEN is_ndj THEN solar_rad END)::numeric, 2) AS "NDJ_sum"
        ...
        ,ROUND(SUM(CASE WHEN is_dry THEN solar_rad END)::numeric, 2) AS "DRY_sum"
        ...
        ,ROUND(SUM(CASE WHEN is_wet THEN solar_rad END)::numeric, 2) AS "WET_sum"
        ...
        ,ROUND(SUM(CASE WHEN is_annual THEN solar_rad END)::numeric, 2) AS "ANNUAL_sum"
        ...
        ,ROUND(SUM(CASE WHEN is_djfm THEN solar_rad END)::numeric, 2) AS "DJFM_sum"
