...
,aggreated_data AS (
    SELECT
        ...
        ,variable
        ,year
        ,MIN(tmin) FILTER(WHERE (is_jfm)) AS "JFM_min"
        ,MAX(tmax) FILTER(WHERE (is_jfm)) AS "JFM_max"
        ...
        ,MIN(tmin) FILTER(WHERE (is_fma)) AS "FMA_min"
        ,MAX(tmax) FILTER(WHERE (is_fma)) AS "FMA_max"
        ...
        ,MIN(tmin) FILTER(WHERE (is_mam)) AS "MAM_min"
        ,MAX(tmax) FILTER(WHERE (is_mam)) AS "MAM_max"
        ...
        ,MIN(tmin) FILTER(WHERE (is_amj)) AS "AMJ_min"
        ,MAX(tmax) FILTER(WHERE (is_amj)) AS "AMJ_max"
        ...
        ,MIN(tmin) FILTER(WHERE (is_mjj)) AS "MJJ_min"
        ,MAX(tmax) FILTER(WHERE (is_mjj)) AS "MJJ_max"
        ...
        ,MIN(tmin) FILTER(WHERE (is_jja)) AS "JJA_min"
        ,MAX(tmax) FILTER(WHERE (is_jja)) AS "JJA_max"
        ...
        ,MIN(tmin) FILTER(WHERE (is_jas)) AS "JAS_min"
        ,MAX(tmax) FILTER(WHERE (is_jas)) AS "JAS_max"
        ...
        ,MIN(tmin) FILTER(WHERE (is_aso)) AS "ASO_min"
        ,MAX(tmax) FILTER(WHERE (is_aso)) AS "ASO_max"
        ...
        ,MIN(tmin) FILTER(WHERE (is_son)) AS "SON_min"
        ,MAX(tmax) FILTER(WHERE (is_son)) AS "SON_max"
        ...
        ,MIN(tmin) FILTER(WHERE (is_ond)) AS "OND_min"
        ,MAX(tmax) FILTER(WHERE (is_ond)) AS "OND_max"
        ...
        ,MIN(tmin) FILTER(WHERE (is_ndj)) AS "NDJ_min"
        ,MAX(tmax) FILTER(WHERE (is_ndj)) AS "NDJ_max"
        ...
        ,MIN(tmin) FILTER(WHERE (is_dry)) AS "DRY_min"
        ,MAX(tmax) FILTER(WHERE (is_dry)) AS "DRY_max"
        ...
        ,MIN(tmin) FILTER(WHERE (is_wet)) AS "WET_min"
        ,MAX(tmax) FILTER(WHERE (is_wet)) AS "WET_max"
        ...
        ,MIN(tmin) FILTER(WHERE (is_annual)) AS "ANNUAL_min"
        ,MAX(tmax) FILTER(WHERE (is_annual)) AS "ANNUAL_max"
        ...
        ,MIN(tmin) FILTER(WHERE (is_djfm)) AS "DJFM_min"
        ,MAX(tmax) FILTER(WHERE (is_djfm)) AS "DJFM_max"
...
SELECT
    ...
    ,CASE 
        ...
        ELSE ROUND("JFM_min"::numeric, 2)::text
    END AS "JFM_min"
    ,CASE 
        WHEN "JFM_max_day_gap" > {{max_day_gap}} THEN 'Gap Exceeded'
        WHEN ROUND(100*("JFM_count"::numeric/"JFM_total"::numeric),2) < (100-{{max_day_pct}}) THEN 'Pct Exceeded'
    ...
    ,CASE 
        ...
        ELSE ROUND("FMA_min"::numeric, 2)::text
    END AS "FMA_min"
    ,CASE 
        WHEN "FMA_max_day_gap" > {{max_day_gap}} THEN 'Gap Exceeded'
        WHEN ROUND(100*("FMA_count"::numeric/"FMA_total"::numeric),2) < (100-{{max_day_pct}}) THEN 'Pct Exceeded'
    ...
    ,CASE 
        ...
        ELSE ROUND("MAM_min"::numeric, 2)::text
    END AS "MAM_min"
    ,CASE 
        WHEN "MAM_max_day_gap" > {{max_day_gap}} THEN 'Gap Exceeded'
        WHEN ROUND(100*("MAM_count"::numeric/"MAM_total"::numeric),2) < (100-{{max_day_pct}}) THEN 'Pct Exceeded'
    ...
    ,CASE 
        ...
        ELSE ROUND("AMJ_min"::numeric, 2)::text
    END AS "AMJ_min"
    ,CASE 
        WHEN "AMJ_max_day_gap" > {{max_day_gap}} THEN 'Gap Exceeded'
        WHEN ROUND(100*("AMJ_count"::numeric/"AMJ_total"::numeric),2) < (100-{{max_day_pct}}) THEN 'Pct Exceeded'
    ...
    ,CASE 
        ...
        ELSE ROUND("MJJ_min"::numeric, 2)::text
    END AS "MJJ_min"
    ,CASE 
        WHEN "MJJ_max_day_gap" > {{max_day_gap}} THEN 'Gap Exceeded'
        WHEN ROUND(100*("MJJ_count"::numeric/"MJJ_total"::numeric),2) < (100-{{max_day_pct}}) THEN 'Pct Exceeded'
    ...
    ,CASE 
        ...
        ELSE ROUND("JJA_min"::numeric, 2)::text
    END AS "JJA_min"
    ,CASE 
        WHEN "JJA_max_day_gap" > {{max_day_gap}} THEN 'Gap Exceeded'
        WHEN ROUND(100*("JJA_count"::numeric/"JJA_total"::numeric),2) < (100-{{max_day_pct}}) THEN 'Pct Exceeded'
    ...
    ,CASE 
        ...
        ELSE ROUND("JAS_min"::numeric, 2)::text
    END AS "JAS_min"
    ,CASE 
        WHEN "JAS_max_day_gap" > {{max_day_gap}} THEN 'Gap Exceeded'
        WHEN ROUND(100*("JAS_count"::numeric/"JAS_total"::numeric),2) < (100-{{max_day_pct}}) THEN 'Pct Exceeded'
    ...
    ,CASE 
        ...
        ELSE ROUND("ASO_min"::numeric, 2)::text
    END AS "ASO_min"
    ,CASE 
        WHEN "ASO_max_day_gap" > {{max_day_gap}} THEN 'Gap Exceeded'
        WHEN ROUND(100*("ASO_count"::numeric/"ASO_total"::numeric),2) < (100-{{max_day_pct}}) THEN 'Pct Exceeded'
    ...
    ,CASE 
        ...
        ELSE ROUND("SON_min"::numeric, 2)::text
    END AS "SON_min"
    ,CASE 
        WHEN "SON_max_day_gap" > {{max_day_gap}} THEN 'Gap Exceeded'
        WHEN ROUND(100*("SON_count"::numeric/"SON_total"::numeric),2) < (100-{{max_day_pct}}) THEN 'Pct Exceeded'
    ...
    ,CASE 
        ...
        ELSE ROUND("OND_min"::numeric, 2)::text
    END AS "OND_min"
    ,CASE 
        WHEN "OND_max_day_gap" > {{max_day_gap}} THEN 'Gap Exceeded'
        WHEN ROUND(100*("OND_count"::numeric/"OND_total"::numeric),2) < (100-{{max_day_pct}}) THEN 'Pct Exceeded'
    ...
    ,CASE 
        ...
        ELSE ROUND("NDJ_min"::numeric, 2)::text
    END AS "NDJ_min"
    ,CASE 
        WHEN "NDJ_max_day_gap" > {{max_day_gap}} THEN 'Gap Exceeded'
        WHEN ROUND(100*("NDJ_count"::numeric/"NDJ_total"::numeric),2) < (100-{{max_day_pct}}) THEN 'Pct Exceeded'
    ...
    ,CASE 
        ...
        ELSE ROUND("DRY_min"::numeric, 2)::text
    END AS "DRY_min"
    ,CASE 
        WHEN "DRY_max_day_gap" > {{max_day_gap}} THEN 'Gap Exceeded'
        WHEN ROUND(100*("DRY_count"::numeric/"DRY_total"::numeric),2) < (100-{{max_day_pct}}) THEN 'Pct Exceeded'
    ...
    ,CASE 
        ...
        ELSE ROUND("WET_min"::numeric, 2)::text
    END AS "WET_min"
    ,CASE 
        WHEN "WET_max_day_gap" > {{max_day_gap}} THEN 'Gap Exceeded'
        WHEN ROUND(100*("WET_count"::numeric/"WET_total"::numeric),2) < (100-{{max_day_pct}}) THEN 'Pct Exceeded'
    ...
    ,CASE 
        ...
        ELSE ROUND("ANNUAL_min"::numeric, 2)::text
    END AS "ANNUAL_min"
    ,CASE 
        WHEN "ANNUAL_max_day_gap" > {{max_day_gap}} THEN 'Gap Exceeded'
        WHEN ROUND(100*("ANNUAL_count"::numeric/"ANNUAL_total"::numeric),2) < (100-{{max_day_pct}}) THEN 'Pct Exceeded'
    ...
    ,CASE 
        ...
        ELSE ROUND("DJFM_min"::numeric, 2)::text
    END AS "DJFM_min"
    ,CASE 
        WHEN "DJFM_max_day_gap" > {{max_day_gap}} THEN 'Gap Exceeded'
        WHEN ROUND(100*("DJFM_count"::numeric/"DJFM_total"::numeric),2) < (100-{{max_day_pct}}) THEN 'Pct Exceeded'
