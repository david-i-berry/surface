...
,aggregation_pct AS (
    SELECT
        station
        ,ad.year
        ,CASE WHEN "JFM_max_day_gap" <= {{max_day_gap}} 
            THEN 
        ...
        ,CASE WHEN "FMA_max_day_gap" <= {{max_day_gap}} 
            THEN 
        ...
        ,CASE WHEN "MAM_max_day_gap" <= {{max_day_gap}} 
            THEN 
        ...
        ,CASE WHEN "AMJ_max_day_gap" <= {{max_day_gap}} 
            THEN 
        ...
        ,CASE WHEN "MJJ_max_day_gap" <= {{max_day_gap}} 
            THEN 
        ...
        ,CASE WHEN "JJA_max_day_gap" <= {{max_day_gap}} 
            THEN 
        ...
        ,CASE WHEN "JAS_max_day_gap" <= {{max_day_gap}} 
            THEN 
        ...
        ,CASE WHEN "ASO_max_day_gap" <= {{max_day_gap}} 
            THEN 
        ...
        ,CASE WHEN "SON_max_day_gap" <= {{max_day_gap}} 
            THEN 
        ...
        ,CASE WHEN "OND_max_day_gap" <= {{max_day_gap}} 
            THEN 
        ...
        ,CASE WHEN "NDJ_max_day_gap" <= {{max_day_gap}} 
            THEN 
        ...
        ,CASE WHEN "DRY_max_day_gap" <= {{max_day_gap}} 
            THEN 
        ...
        ,CASE WHEN "WET_max_day_gap" <= {{max_day_gap}} 
            THEN 
        ...
        ,CASE WHEN "ANNUAL_max_day_gap" <= {{max_day_gap}} 
            THEN 
        ...
        ,CASE WHEN "DJFM_max_day_gap" <= {{max_day_gap}} 
            THEN 
