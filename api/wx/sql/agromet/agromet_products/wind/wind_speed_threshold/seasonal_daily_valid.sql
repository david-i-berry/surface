...
,aggreated_data AS (
    SELECT
        ...
        ,SUM(CASE WHEN is_fma THEN value END) AS "FMA"
        ...
        ,SUM(CASE WHEN is_mam THEN value END) AS "MAM"
        ...
        ,SUM(CASE WHEN is_amj THEN value END) AS "AMJ"
        ...
        ,SUM(CASE WHEN is_mjj THEN value END) AS "MJJ"
        ...
        ,SUM(CASE WHEN is_jja THEN value END) AS "JJA"
        ...
        ,SUM(CASE WHEN is_jas THEN value END) AS "JAS"
        ...
        ,SUM(CASE WHEN is_aso THEN value END) AS "ASO"
        ...
        ,SUM(CASE WHEN is_son THEN value END) AS "SON"
        ...
        ,SUM(CASE WHEN is_ond THEN value END) AS "OND"
        ...
        ,SUM(CASE WHEN is_ndj THEN value END) AS "NDJ"
        ...
        ,SUM(CASE WHEN is_dry THEN value END) AS "DRY"
        ...
        ,SUM(CASE WHEN is_wet THEN value END) AS "WET"
        ...
        ,SUM(CASE WHEN is_annual THEN value END) AS "ANNUAL"
        ...
        ,SUM(CASE WHEN is_djfm THEN value END) AS "DJFM"
