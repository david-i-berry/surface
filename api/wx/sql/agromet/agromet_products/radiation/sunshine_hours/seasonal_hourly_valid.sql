...
,daily_data AS (
    ...
    FROM (
        SELECT
            ...
            ,SUM(sum_value) AS sunshine_hours
        FROM hourly_data
...
,aggreated_data AS (
    SELECT
        st.name AS station
        ,year
        ,SUM(sunshine_hours) FILTER(WHERE is_jfm) AS "JFM_sunshine_hours"
        ...
        ,SUM(sunshine_hours) FILTER(WHERE is_fma) AS "FMA_sunshine_hours"
        ...
        ,SUM(sunshine_hours) FILTER(WHERE is_mam) AS "MAM_sunshine_hours"
        ...
        ,SUM(sunshine_hours) FILTER(WHERE is_amj) AS "AMJ_sunshine_hours"
        ...
        ,SUM(sunshine_hours) FILTER(WHERE is_mjj) AS "MJJ_sunshine_hours"
        ...
        ,SUM(sunshine_hours) FILTER(WHERE is_jja) AS "JJA_sunshine_hours"
        ...
        ,SUM(sunshine_hours) FILTER(WHERE is_jas) AS "JAS_sunshine_hours"
        ...
        ,SUM(sunshine_hours) FILTER(WHERE is_aso) AS "ASO_sunshine_hours"
        ...
        ,SUM(sunshine_hours) FILTER(WHERE is_son) AS "SON_sunshine_hours"
        ...
        ,SUM(sunshine_hours) FILTER(WHERE is_ond) AS "OND_sunshine_hours"
        ...
        ,SUM(sunshine_hours) FILTER(WHERE is_ndj) AS "NDJ_sunshine_hours"
        ...
        ,SUM(sunshine_hours) FILTER(WHERE is_dry) AS "DRY_sunshine_hours"
        ...
        ,SUM(sunshine_hours) FILTER(WHERE is_wet) AS "WET_sunshine_hours"
        ...
        ,SUM(sunshine_hours) FILTER(WHERE is_annual) AS "ANNUAL_sunshine_hours"
        ...
        ,SUM(sunshine_hours) FILTER(WHERE is_djfm) AS "DJFM_sunshine_hours"
...
SELECT
    ...
    ,CASE 
        ...
        ELSE ROUND("JFM_sunshine_hours"::numeric,2)::text
    END AS "JFM"
    ...
    ,CASE 
        ...
        ELSE ROUND("FMA_sunshine_hours"::numeric,2)::text
    END AS "FMA"
    ...
    ,CASE 
        ...
        ELSE ROUND("MAM_sunshine_hours"::numeric,2)::text
    END AS "MAM"
    ...
    ,CASE 
        ...
        ELSE ROUND("AMJ_sunshine_hours"::numeric,2)::text
    END AS "AMJ"
    ...
    ,CASE 
        ...
        ELSE ROUND("MJJ_sunshine_hours"::numeric,2)::text
    END AS "MJJ"
    ...
    ,CASE 
        ...
        ELSE ROUND("JJA_sunshine_hours"::numeric,2)::text
    END AS "JJA"
    ...
    ,CASE 
        ...
        ELSE ROUND("JAS_sunshine_hours"::numeric,2)::text
    END AS "JAS"
    ...
    ,CASE 
        ...
        ELSE ROUND("ASO_sunshine_hours"::numeric,2)::text
    END AS "ASO"
    ...
    ,CASE 
        ...
        ELSE ROUND("SON_sunshine_hours"::numeric,2)::text
    END AS "SON"
    ...
    ,CASE 
        ...
        ELSE ROUND("OND_sunshine_hours"::numeric,2)::text
    END AS "OND"
    ...
    ,CASE 
        ...
        ELSE ROUND("NDJ_sunshine_hours"::numeric,2)::text
    END AS "NDJ"
    ...
    ,CASE 
        ...
        ELSE ROUND("DRY_sunshine_hours"::numeric,2)::text
    END AS "DRY"
    ...
    ,CASE 
        ...
        ELSE ROUND("WET_sunshine_hours"::numeric,2)::text
    END AS "WET"
    ...
    ,CASE 
        ...
        ELSE ROUND("ANNUAL_sunshine_hours"::numeric,2)::text
    END AS "ANNUAL"
    ...
    ,CASE 
        ...
        ELSE ROUND("DJFM_sunshine_hours"::numeric,2)::text
    END AS "DJFM"
