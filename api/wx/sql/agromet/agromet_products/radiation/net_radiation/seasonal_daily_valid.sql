...
-- Allen et al. (1998), FAO-56 (Equation 38).
CREATE OR REPLACE FUNCTION ms_net_sw_radiation(
    tmin float,                    -- °C (daily minimum temperature)
    tmax float,                    -- °C (daily maximum temperature)
    latitude float,                -- ° (latitude in decimal degrees)
    day_of_year integer,           -- 1-366 (day of year)
...
BEGIN 
    ...
    R_sn := ms_net_sw_radiation(tmin, tmax, latitude, day_of_year, inland_station);
...
,aggreated_data AS (
    SELECT
        ...
        ,SUM(net_shortwave_rad) FILTER(WHERE is_jfm) AS "JFM_net_sw_rad"
        ,SUM(net_longwave_rad) FILTER(WHERE is_jfm) AS "JFM_net_lw_rad"
        ,SUM(net_rad) FILTER(WHERE is_jfm) AS "JFM_net_rad"
        ...
        ,SUM(net_shortwave_rad) FILTER(WHERE is_fma) AS "FMA_net_sw_rad"
        ,SUM(net_longwave_rad) FILTER(WHERE is_fma) AS "FMA_net_lw_rad"
        ,SUM(net_rad) FILTER(WHERE is_fma) AS "FMA_net_rad"
        ...
        ,SUM(net_shortwave_rad) FILTER(WHERE is_mam) AS "MAM_net_sw_rad"
        ,SUM(net_longwave_rad) FILTER(WHERE is_mam) AS "MAM_net_lw_rad"
        ,SUM(net_rad) FILTER(WHERE is_mam) AS "MAM_net_rad"
        ...
        ,SUM(net_shortwave_rad) FILTER(WHERE is_amj) AS "AMJ_net_sw_rad"
        ,SUM(net_longwave_rad) FILTER(WHERE is_amj) AS "AMJ_net_lw_rad"
        ,SUM(net_rad) FILTER(WHERE is_amj) AS "AMJ_net_rad"
        ...
        ,SUM(net_shortwave_rad) FILTER(WHERE is_mjj) AS "MJJ_net_sw_rad"
        ,SUM(net_longwave_rad) FILTER(WHERE is_mjj) AS "MJJ_net_lw_rad"
        ,SUM(net_rad) FILTER(WHERE is_mjj) AS "MJJ_net_rad"
        ...
        ,SUM(net_shortwave_rad) FILTER(WHERE is_jja) AS "JJA_net_sw_rad"
        ,SUM(net_longwave_rad) FILTER(WHERE is_jja) AS "JJA_net_lw_rad"
        ,SUM(net_rad) FILTER(WHERE is_jja) AS "JJA_net_rad"
        ...
        ,SUM(net_shortwave_rad) FILTER(WHERE is_jas) AS "JAS_net_sw_rad"
        ,SUM(net_longwave_rad) FILTER(WHERE is_jas) AS "JAS_net_lw_rad"
        ,SUM(net_rad) FILTER(WHERE is_jas) AS "JAS_net_rad"
        ...
        ,SUM(net_shortwave_rad) FILTER(WHERE is_aso) AS "ASO_net_sw_rad"
        ,SUM(net_longwave_rad) FILTER(WHERE is_aso) AS "ASO_net_lw_rad"
        ,SUM(net_rad) FILTER(WHERE is_aso) AS "ASO_net_rad"
        ...
        ,SUM(net_shortwave_rad) FILTER(WHERE is_son) AS "SON_net_sw_rad"
        ,SUM(net_longwave_rad) FILTER(WHERE is_son) AS "SON_net_lw_rad"
        ,SUM(net_rad) FILTER(WHERE is_son) AS "SON_net_rad"
        ...
        ,SUM(net_shortwave_rad) FILTER(WHERE is_ond) AS "OND_net_sw_rad"
        ,SUM(net_longwave_rad) FILTER(WHERE is_ond) AS "OND_net_lw_rad"
        ,SUM(net_rad) FILTER(WHERE is_ond) AS "OND_net_rad"
        ...
        ,SUM(net_shortwave_rad) FILTER(WHERE is_ndj) AS "NDJ_net_sw_rad"
        ,SUM(net_longwave_rad) FILTER(WHERE is_ndj) AS "NDJ_net_lw_rad"
        ,SUM(net_rad) FILTER(WHERE is_ndj) AS "NDJ_net_rad"
        ...
        ,SUM(net_shortwave_rad) FILTER(WHERE is_dry) AS "DRY_net_sw_rad"
        ,SUM(net_longwave_rad) FILTER(WHERE is_dry) AS "DRY_net_lw_rad"
        ,SUM(net_rad) FILTER(WHERE is_dry) AS "DRY_net_rad"
        ...
        ,SUM(net_shortwave_rad) FILTER(WHERE is_wet) AS "WET_net_sw_rad"
        ,SUM(net_longwave_rad) FILTER(WHERE is_wet) AS "WET_net_lw_rad"
        ,SUM(net_rad) FILTER(WHERE is_wet) AS "WET_net_rad"
        ...
        ,SUM(net_shortwave_rad) FILTER(WHERE is_annual) AS "ANNUAL_net_sw_rad"
        ,SUM(net_longwave_rad) FILTER(WHERE is_annual) AS "ANNUAL_net_lw_rad"
        ,SUM(net_rad) FILTER(WHERE is_annual) AS "ANNUAL_net_rad"
        ...
        ,SUM(net_shortwave_rad) FILTER(WHERE is_djfm) AS "DJFM_net_sw_rad"
        ,SUM(net_longwave_rad) FILTER(WHERE is_djfm) AS "DJFM_net_lw_rad"
        ,SUM(net_rad) FILTER(WHERE is_djfm) AS "DJFM_net_rad"
...
SELECT
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'Solar Radiation' THEN ROUND("JFM_solar_rad"::numeric,2)::text
                WHEN 'Net Radiation' THEN ROUND("JFM_net_rad"::numeric,2)::text
                WHEN 'Net Shortwave Radiation' THEN ROUND("JFM_net_sw_rad"::numeric,2)::text
                WHEN 'Net Longwave Radiation' THEN ROUND("JFM_net_lw_rad"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "JFM"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'Solar Radiation' THEN ROUND("FMA_solar_rad"::numeric,2)::text
                WHEN 'Net Radiation' THEN ROUND("FMA_net_rad"::numeric,2)::text
                WHEN 'Net Shortwave Radiation' THEN ROUND("FMA_net_sw_rad"::numeric,2)::text
                WHEN 'Net Longwave Radiation' THEN ROUND("FMA_net_lw_rad"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "FMA"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'Solar Radiation' THEN ROUND("MAM_solar_rad"::numeric,2)::text
                WHEN 'Net Radiation' THEN ROUND("MAM_net_rad"::numeric,2)::text
                WHEN 'Net Shortwave Radiation' THEN ROUND("MAM_net_sw_rad"::numeric,2)::text
                WHEN 'Net Longwave Radiation' THEN ROUND("MAM_net_lw_rad"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "MAM"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'Solar Radiation' THEN ROUND("AMJ_solar_rad"::numeric,2)::text
                WHEN 'Net Radiation' THEN ROUND("AMJ_net_rad"::numeric,2)::text
                WHEN 'Net Shortwave Radiation' THEN ROUND("AMJ_net_sw_rad"::numeric,2)::text
                WHEN 'Net Longwave Radiation' THEN ROUND("AMJ_net_lw_rad"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "AMJ"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'Solar Radiation' THEN ROUND("MJJ_solar_rad"::numeric,2)::text
                WHEN 'Net Radiation' THEN ROUND("MJJ_net_rad"::numeric,2)::text
                WHEN 'Net Shortwave Radiation' THEN ROUND("MJJ_net_sw_rad"::numeric,2)::text
                WHEN 'Net Longwave Radiation' THEN ROUND("MJJ_net_lw_rad"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "MJJ"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'Solar Radiation' THEN ROUND("JJA_solar_rad"::numeric,2)::text
                WHEN 'Net Radiation' THEN ROUND("JJA_net_rad"::numeric,2)::text
                WHEN 'Net Shortwave Radiation' THEN ROUND("JJA_net_sw_rad"::numeric,2)::text
                WHEN 'Net Longwave Radiation' THEN ROUND("JJA_net_lw_rad"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "JJA"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'Solar Radiation' THEN ROUND("JAS_solar_rad"::numeric,2)::text
                WHEN 'Net Radiation' THEN ROUND("JAS_net_rad"::numeric,2)::text
                WHEN 'Net Shortwave Radiation' THEN ROUND("JAS_net_sw_rad"::numeric,2)::text
                WHEN 'Net Longwave Radiation' THEN ROUND("JAS_net_lw_rad"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "JAS"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'Solar Radiation' THEN ROUND("ASO_solar_rad"::numeric,2)::text
                WHEN 'Net Radiation' THEN ROUND("ASO_net_rad"::numeric,2)::text
                WHEN 'Net Shortwave Radiation' THEN ROUND("ASO_net_sw_rad"::numeric,2)::text
                WHEN 'Net Longwave Radiation' THEN ROUND("ASO_net_lw_rad"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "ASO"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'Solar Radiation' THEN ROUND("SON_solar_rad"::numeric,2)::text
                WHEN 'Net Radiation' THEN ROUND("SON_net_rad"::numeric,2)::text
                WHEN 'Net Shortwave Radiation' THEN ROUND("SON_net_sw_rad"::numeric,2)::text
                WHEN 'Net Longwave Radiation' THEN ROUND("SON_net_lw_rad"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "SON"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'Solar Radiation' THEN ROUND("OND_solar_rad"::numeric,2)::text
                WHEN 'Net Radiation' THEN ROUND("OND_net_rad"::numeric,2)::text
                WHEN 'Net Shortwave Radiation' THEN ROUND("OND_net_sw_rad"::numeric,2)::text
                WHEN 'Net Longwave Radiation' THEN ROUND("OND_net_lw_rad"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "OND"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'Solar Radiation' THEN ROUND("NDJ_solar_rad"::numeric,2)::text
                WHEN 'Net Radiation' THEN ROUND("NDJ_net_rad"::numeric,2)::text
                WHEN 'Net Shortwave Radiation' THEN ROUND("NDJ_net_sw_rad"::numeric,2)::text
                WHEN 'Net Longwave Radiation' THEN ROUND("NDJ_net_lw_rad"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "NDJ"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'Solar Radiation' THEN ROUND("DRY_solar_rad"::numeric,2)::text
                WHEN 'Net Radiation' THEN ROUND("DRY_net_rad"::numeric,2)::text
                WHEN 'Net Shortwave Radiation' THEN ROUND("DRY_net_sw_rad"::numeric,2)::text
                WHEN 'Net Longwave Radiation' THEN ROUND("DRY_net_lw_rad"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "DRY"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'Solar Radiation' THEN ROUND("WET_solar_rad"::numeric,2)::text
                WHEN 'Net Radiation' THEN ROUND("WET_net_rad"::numeric,2)::text
                WHEN 'Net Shortwave Radiation' THEN ROUND("WET_net_sw_rad"::numeric,2)::text
                WHEN 'Net Longwave Radiation' THEN ROUND("WET_net_lw_rad"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "WET"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'Solar Radiation' THEN ROUND("ANNUAL_solar_rad"::numeric,2)::text
                WHEN 'Net Radiation' THEN ROUND("ANNUAL_net_rad"::numeric,2)::text
                WHEN 'Net Shortwave Radiation' THEN ROUND("ANNUAL_net_sw_rad"::numeric,2)::text
                WHEN 'Net Longwave Radiation' THEN ROUND("ANNUAL_net_lw_rad"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "ANNUAL"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'Solar Radiation' THEN ROUND("DJFM_solar_rad"::numeric,2)::text
                WHEN 'Net Radiation' THEN ROUND("DJFM_net_rad"::numeric,2)::text
                WHEN 'Net Shortwave Radiation' THEN ROUND("DJFM_net_sw_rad"::numeric,2)::text
                WHEN 'Net Longwave Radiation' THEN ROUND("DJFM_net_lw_rad"::numeric,2)::text                                
                ELSE NULL
            END
    END AS "DJFM"
