...
,aggreated_data AS (
    SELECT
        st.name AS station
        ,year
        ,SUM(sum_evapo) FILTER(WHERE is_jfm) AS "JFM_sum_evapo"
        ...
        ,SUM(sum_evapo) FILTER(WHERE is_fma) AS "FMA_sum_evapo"
        ...
        ,SUM(sum_evapo) FILTER(WHERE is_mam) AS "MAM_sum_evapo"
        ...
        ,SUM(sum_evapo) FILTER(WHERE is_amj) AS "AMJ_sum_evapo"
        ...
        ,SUM(sum_evapo) FILTER(WHERE is_mjj) AS "MJJ_sum_evapo"
        ...
        ,SUM(sum_evapo) FILTER(WHERE is_jja) AS "JJA_sum_evapo"
        ...
        ,SUM(sum_evapo) FILTER(WHERE is_jas) AS "JAS_sum_evapo"
        ...
        ,SUM(sum_evapo) FILTER(WHERE is_aso) AS "ASO_sum_evapo"
        ...
        ,SUM(sum_evapo) FILTER(WHERE is_son) AS "SON_sum_evapo"
        ...
        ,SUM(sum_evapo) FILTER(WHERE is_ond) AS "OND_sum_evapo"
        ...
        ,SUM(sum_evapo) FILTER(WHERE is_ndj) AS "NDJ_sum_evapo"
        ...
        ,SUM(sum_evapo) FILTER(WHERE is_dry) AS "DRY_sum_evapo"
        ...
        ,SUM(sum_evapo) FILTER(WHERE is_wet) AS "WET_sum_evapo"
        ...
        ,SUM(sum_evapo) FILTER(WHERE is_annual) AS "ANNUAL_sum_evapo"
        ...
        ,SUM(sum_evapo) FILTER(WHERE is_djfm) AS "DJFM_sum_evapo"
...
SELECT
    station
    ,'Accumulative Evaporation' AS product
    ,ad.year
    ,CASE 
        ...
        ELSE ROUND("JFM_sum_evapo"::numeric,2)::text
    END AS "JFM"
    ...
    ,CASE 
        ...
        ELSE ROUND("FMA_sum_evapo"::numeric,2)::text
    END AS "FMA"
    ...
    ,CASE 
        ...
        ELSE ROUND("MAM_sum_evapo"::numeric,2)::text
    END AS "MAM"
    ...
    ,CASE 
        ...
        ELSE ROUND("AMJ_sum_evapo"::numeric,2)::text
    END AS "AMJ"
    ...
    ,CASE 
        ...
        ELSE ROUND("MJJ_sum_evapo"::numeric,2)::text
    END AS "MJJ"
    ...
    ,CASE 
        ...
        ELSE ROUND("JJA_sum_evapo"::numeric,2)::text
    END AS "JJA"
    ...
    ,CASE 
        ...
        ELSE ROUND("JAS_sum_evapo"::numeric,2)::text
    END AS "JAS"
    ...
    ,CASE 
        ...
        ELSE ROUND("ASO_sum_evapo"::numeric,2)::text
    END AS "ASO"
    ...
    ,CASE 
        ...
        ELSE ROUND("SON_sum_evapo"::numeric,2)::text
    END AS "SON"
    ...
    ,CASE 
        ...
        ELSE ROUND("OND_sum_evapo"::numeric,2)::text
    END AS "OND"
    ...
    ,CASE 
        ...
        ELSE ROUND("NDJ_sum_evapo"::numeric,2)::text
    END AS "NDJ"
    ...
    ,CASE 
        ...
        ELSE ROUND("DRY_sum_evapo"::numeric,2)::text
    END AS "DRY"
    ...
    ,CASE 
        ...
        ELSE ROUND("WET_sum_evapo"::numeric,2)::text
    END AS "WET"
    ...
    ,CASE 
        ...
        ELSE ROUND("ANNUAL_sum_evapo"::numeric,2)::text
    END AS "ANNUAL"
    ...
    ,CASE 
        ...
        ELSE ROUND("DJFM_sum_evapo"::numeric,2)::text
    END AS "DJFM"
