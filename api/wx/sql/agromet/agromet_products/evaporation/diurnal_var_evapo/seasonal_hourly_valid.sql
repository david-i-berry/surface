...
SELECT
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'MIN' THEN "JFM_min"::text
                WHEN 'MAX' THEN "JFM_max"::text
                WHEN 'AVG' THEN "JFM_avg"::text
                ELSE NULL
            END
    END AS "JFM"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'MIN' THEN "FMA_min"::text
                WHEN 'MAX' THEN "FMA_max"::text
                WHEN 'AVG' THEN "FMA_avg"::text
                ELSE NULL
            END
    END AS "FMA"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'MIN' THEN "MAM_min"::text
                WHEN 'MAX' THEN "MAM_max"::text
                WHEN 'AVG' THEN "MAM_avg"::text
                ELSE NULL
            END
    END AS "MAM"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'MIN' THEN "AMJ_min"::text
                WHEN 'MAX' THEN "AMJ_max"::text
                WHEN 'AVG' THEN "AMJ_avg"::text
                ELSE NULL
            END
    END AS "AMJ"    
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'MIN' THEN "MJJ_min"::text
                WHEN 'MAX' THEN "MJJ_max"::text
                WHEN 'AVG' THEN "MJJ_avg"::text
                ELSE NULL
            END
    END AS "MJJ"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'MIN' THEN "JJA_min"::text
                WHEN 'MAX' THEN "JJA_max"::text
                WHEN 'AVG' THEN "JJA_avg"::text
                ELSE NULL
            END
    END AS "JJA"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'MIN' THEN "JAS_min"::text
                WHEN 'MAX' THEN "JAS_max"::text
                WHEN 'AVG' THEN "JAS_avg"::text
                ELSE NULL
            END
    END AS "JAS"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'MIN' THEN "ASO_min"::text
                WHEN 'MAX' THEN "ASO_max"::text
                WHEN 'AVG' THEN "ASO_avg"::text
                ELSE NULL
            END
    END AS "ASO"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'MIN' THEN "SON_min"::text
                WHEN 'MAX' THEN "SON_max"::text
                WHEN 'AVG' THEN "SON_avg"::text
                ELSE NULL
            END
    END AS "SON"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'MIN' THEN "OND_min"::text
                WHEN 'MAX' THEN "OND_max"::text
                WHEN 'AVG' THEN "OND_avg"::text
                ELSE NULL
            END
    END AS "OND"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'MIN' THEN "NDJ_min"::text
                WHEN 'MAX' THEN "NDJ_max"::text
                WHEN 'AVG' THEN "NDJ_avg"::text
                ELSE NULL
            END
    END AS "NDJ"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'MIN' THEN "DRY_min"::text
                WHEN 'MAX' THEN "DRY_max"::text
                WHEN 'AVG' THEN "DRY_avg"::text
                ELSE NULL
            END
    END AS "DRY"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'MIN' THEN "WET_min"::text
                WHEN 'MAX' THEN "WET_max"::text
                WHEN 'AVG' THEN "WET_avg"::text
                ELSE NULL
            END
    END AS "WET"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'MIN' THEN "ANNUAL_min"::text
                WHEN 'MAX' THEN "ANNUAL_max"::text
                WHEN 'AVG' THEN "ANNUAL_avg"::text
                ELSE NULL
            END
    END AS "ANNUAL"
    ...
    ,CASE 
        ...
        ELSE
            CASE product
                WHEN 'MIN' THEN "DJFM_min"::text
                WHEN 'MAX' THEN "DJFM_max"::text
                WHEN 'AVG' THEN "DJFM_avg"::text
                ELSE NULL
            END
    END AS "DJFM"
