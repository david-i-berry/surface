    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emergence_cd', models.IntegerField(default=8, help_text='Calendar days from sowing to emergence/transplant recovery', verbose_name='Emergence')),
                ...
                ('max_rooting_cd', models.IntegerField(default=60, help_text='Calendar days from sowing to maximum rooting', verbose_name='MaxRootingCD')),
                ...
                ('senescence_cd', models.IntegerField(default=105, help_text='Calendar days from sowing to senescence', verbose_name='SenescenceCD')),
                ...
                ('maturity_cd', models.IntegerField(default=140, help_text='Calendar days from sowing to maturity', verbose_name='MaturityCD')),
                ...
                ('hi_start_cd', models.IntegerField(default=70, help_text='Calendar days from sowing to start of yield formation', verbose_name='HIstartCD')),
                ...
                ('flowering_cd', models.IntegerField(default=105, help_text='Duration of flowering in calendar days (-999 for non-fruit/grain crops)', verbose_name='FloweringCD')),
                ...
                ('yld_form_cd', models.IntegerField(default=60, help_text='Duration of yield formation in calendar days', verbose_name='YldFormCD')),
                ('yld_wc', models.IntegerField(default=60, verbose_name='YldWC')),
                ...
                ('cdc_cd', models.FloatField(default=0.08, help_text='Canopy decline coefficient (fraction per calendar day)', verbose_name='CDC_CD')),
                ('cgc', models.FloatField(default=0.0125, help_text='Canopy growth coefficient (fraction per GDD)', verbose_name='CGC')),
                ('cgc_cd', models.FloatField(default=0.012, help_text='Canopy growth coefficient (fraction per calendar day)', verbose_name='CGC_CD')),
